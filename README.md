...
> Prefer clicking to typing? **[Configure a Go project in the browser →](https://packkit-web.pages.dev/?g=go)** — pick options, preview the tree, download a zip (or copy the command). No install needed.
